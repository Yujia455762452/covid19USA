...
stock_ymd <- read.csv("https://raw.githubusercontent.com/Yujia455762452/covid19USA/master/GOOG_stock.csv",header = TRUE,sep = ",",quote = '"') 
stock_ymd$date <- lubridate::ymd(stock_ymd$date)
...
# map data
American_map <-read.csv("https://raw.githubusercontent.com/Yujia455762452/covid19USA/master/American_map_data.csv")
# map cloor
map_color <-read.csv("https://raw.githubusercontent.com/Yujia455762452/covid19USA/master/covid_20201001.csv")
...
map_join$Total_recovered_q<-cut(map_join$Total_recovered,breaks = c(0,5000,10000,50000,100000,500000,max(map_join$Total_recovered)*1.2),
                            labels = c("5k-","5k-10k","10k-50k", "50k-100k","100k-500k","500k+"),include.lowest = TRUE)
